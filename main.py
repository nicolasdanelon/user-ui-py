...
class App(customtkinter.CTk):
    ...
    def confirm_update(self):
        answer = askyesno(title='Update user onfirmation', message='Are you sure that you want to update the user?')
        if answer:
    ...
    def print_edit_form(self):
        ...
        self.edit_submit_button = customtkinter.CTkButton(self.edit_form, command=self.confirm_update, text="Update user")
